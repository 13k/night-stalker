...
func TestLiveMatchPlayers_MatchIDs(t *testing.T) {
	testCases := []struct {
		Subject  nscol.LiveMatchPlayers
...
func TestLiveMatchPlayers_AccountIDs(t *testing.T) {
	testCases := []struct {
		Subject  nscol.LiveMatchPlayers
...
func TestLiveMatchPlayers_GroupByMatchID(t *testing.T) {
	testCases := []struct {
		Subject  nscol.LiveMatchPlayers
		Expected map[nspb.MatchID]nscol.LiveMatchPlayers
	}{
		{
			Subject:  nil,
			Expected: nil,
...
func TestLiveMatchPlayers_GroupByAccountID(t *testing.T) {
	testCases := []struct {
		Subject  nscol.LiveMatchPlayers
		Expected map[nspb.AccountID]nscol.LiveMatchPlayers
	}{
		{
			Subject:  nil,
			Expected: nil,

...
func TestProPlayers_AccountIDs(t *testing.T) {
	testCases := []struct {
		Subject  nscol.ProPlayers
...
func TestProPlayers_GroupByAccountID(t *testing.T) {
	testCases := []struct {
		Subject  nscol.ProPlayers
		Expected map[nspb.AccountID]nscol.ProPlayers
	}{
		{
			Subject:  nil,
			Expected: nil,
...
func TestProPlayers_KeyByAccountID(t *testing.T) {
	testCases := []struct {
		Subject  nscol.ProPlayers
		Expected map[nspb.AccountID]*models.ProPlayer
	}{
		{
			Subject:  nil,
			Expected: nil,

...
func TestMatchPlayers_MatchIDs(t *testing.T) {
	testCases := []struct {
...
func TestMatchPlayers_AccountIDs(t *testing.T) {
	testCases := []struct {
		Subject  nscol.MatchPlayers
...
func TestMatchPlayers_GroupByMatchID(t *testing.T) {
	testCases := []struct {
		Subject  nscol.MatchPlayers
		Expected map[nspb.MatchID]nscol.MatchPlayers
	}{
		{
			Subject:  nil,
			Expected: nil,
...
func TestMatchPlayers_GroupByAccountID(t *testing.T) {
	testCases := []struct {
		Subject  nscol.MatchPlayers
		Expected map[nspb.AccountID]nscol.MatchPlayers
	}{
		{
			Subject:  nil,
			Expected: nil,
